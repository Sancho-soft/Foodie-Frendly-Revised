...
<div class="container">
    <div class="card shadow">
        <div class="card-header" style="background-color: #c8a879;">
            <h3 class="m-0 font-weight-bold">Add New Rider</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.riders.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="license_code" class="form-control @error('license_code') is-invalid @enderror" value="{{ old('license_code') }}" required>
                        @error('license_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
